...
import { generateBlogContent, improveContent } from "@/app/actions/openai";
...
export default function PostEditorContent({
  ...
  return (
    <>
        ...
        <div className="space-y-5">
          ...
          {watchedValues.featuredImage ? (
            ...
            <>
              ...
              <button
                onClick={() => setShowUnsplash(true)}
                className="w-full py-2 rounded-md bg-slate-800 hover:bg-slate-700"
              >
                Search Unsplash
              </button>
            </>
      ...
      {showDiff && originalContent && aiContent && (
        <AIDiffModal
